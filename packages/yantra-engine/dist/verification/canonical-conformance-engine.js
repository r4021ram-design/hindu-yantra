...
exports.SGOSCanonicalConformanceEngine = void 0;
const compiler_1 = require("../geometry/compiler");
const reference_dataset_1 = require("./reference-dataset");
class SGOSCanonicalConformanceEngine {
    /**
     * Evaluates compiled geometry against the immutable CANONICAL_SRI_CHAKRA_REFERENCE_DATASET benchmark.
     */
    static auditConformance(dsl, reference = reference_dataset_1.CANONICAL_SRI_CHAKRA_REFERENCE_DATASET) {
        ...
        const binduDev = Math.sqrt(Math.pow(bindu.cx - reference.expectedGeometry.binduCoordinates.x, 2) +
...
exports.SGOSCanonicalConformanceEngine = SGOSCanonicalConformanceEngine;
