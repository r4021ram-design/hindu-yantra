...
export type IGRPrimitiveType = 'point' | 'line_segment' | 'triangle' | 'polygon' | 'circle' | 'arc' | 'lotus_petal_group' | 'bhupura_contour';
...
export type IGRNode = IGRPointNode | IGRLineSegmentNode | IGRPolygonNode | IGRCircleNode | IGRLotusPetalGroupNode | IGRBhupuraNode;
