...
export type GeometricConstraintType = 'coincident_point' | 'collinear' | 'concentric' | 'parallel' | 'perpendicular' | 'equal_length' | 'equal_radius' | 'fixed_angle' | 'symmetry' | 'tangency';
export type SacredConstraintType = 'bindu_at_origin' | 'lotus_concentricity' | 'bhupura_squareness' | 'triangle_orientation' | 'navavarana_ordering' | 'layer_containment' | 'radial_symmetry' | 'tradition_rules';
