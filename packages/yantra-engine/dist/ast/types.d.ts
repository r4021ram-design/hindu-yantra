export type ASTNodeType = 'GeometryRoot' | 'LayerNode' | 'BinduNode' | 'CircleNode' | 'LotusNode' | 'TriangleNode' | 'PolygonNode' | 'BhupuraNode' | 'GroupNode' | 'TransformNode' | 'ConstraintNode' | 'MetadataNode' | 'ReferenceNode';
...
export type ASTNode = GeometryRootNode | LayerNode | BinduNode | CircleNode | LotusNode | TriangleNode | PolygonNode | BhupuraNode | GroupNode | TransformNode | ConstraintNode | MetadataNode | ReferenceNode;
