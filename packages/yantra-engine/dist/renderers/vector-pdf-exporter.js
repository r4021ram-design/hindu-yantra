...
exports.VectorPDFExporter = void 0;
...
class VectorPDFExporter {
     ...
     */
    static generateVectorPDF(target, options = {}) {
        ...
        const svgStr = svg_renderer_1.SVGRenderer.renderToString(target, options);
...
exports.VectorPDFExporter = VectorPDFExporter;
