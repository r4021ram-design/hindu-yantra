...
exports.SGOSAvaranaCalloutEngine = void 0;
class SGOSAvaranaCalloutEngine {
    static avaranaGroups = new Map();
    ...
    static getAvaranaGroup(avaranaIndex) {
        this.initIfNeeded();
        return this.avaranaGroups.get(avaranaIndex) || this.avaranaGroups.get(5);
    }
}
exports.SGOSAvaranaCalloutEngine = SGOSAvaranaCalloutEngine;
