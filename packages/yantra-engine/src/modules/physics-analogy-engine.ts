...
export class SGOSPhysicsAnalogyEngine {
  private static analogies: Map<string, YantraPhysicsAnalogy> = new Map();
  ...
  public static getAnalogy(yantraId: string): YantraPhysicsAnalogy {
    this.initIfNeeded();
