...
export class GeometryGraphBuilder {
  /**
   * Pipeline Stage: Converts IGR into a fully connected topological GeometryGraph.
   */
  public static build(igr: IntermediateGeometryRepresentation): GeometryGraph {
    const nodes: Record<string, GraphNode> = {};
    const edges: Record<string, GraphEdge> = {};
    const faces: Record<string, GraphFace> = {};
    const regions: GraphRegion[] = [];
    const layers: GraphLayer[] = [];
    const outerBoundaryEdgeIds: string[] = [];
