...
export class DSLParser {
   ...
   */
  public static parse(input: string | Record<string, unknown> | YantraDSL | any): YantraDSL {
    const rawObj: any = typeof input === 'string' ? JSON.parse(input) : input;
    ...
    const dsl: YantraDSL = {
      ...
      version: (rawObj.version as string) || '1.0.0',
      traditionVariant: (rawObj.traditionVariant as string) || 'Traditional',
      names: {
